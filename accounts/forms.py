...
class RegisterForm(forms.Form):
    ...
    password1 = forms.CharField(error_messages=messages, widget=forms.PasswordInput(
        attrs={'class': 'form-control'}))
    password2 = forms.CharField(error_messages=messages, widget=forms.PasswordInput(
        attrs={'class': 'form-control'}))
